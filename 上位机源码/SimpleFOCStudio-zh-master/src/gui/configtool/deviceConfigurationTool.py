...
class DeviceConfigurationTool(WorkAreaTabWidget):
    ...
    def __init__(self, parent=None):
        ...
        trace('[UI] DeviceConfigurationTool.__init__ enter')
        ...
        trace('[UI] DeviceConfigurationTool.__init__ done')
    ...
    def configureConnection(self, configvalues):
        trace('[UI] DeviceConfigurationTool.configureConnection values=%r', configvalues)
