...
class GeneralSettingsGroupBox(QtWidgets.QGroupBox):
    ...
    def sendMotionDownsampleAction(self):
        ...
        trace('[UI] motion downsample editingFinished raw=%r', value)
        value = value.replace(',', '.')
    ...
    def sendCurrentLimitAction(self):
        ...
        trace('[UI] current limit editingFinished raw=%r', value)
        value = value.replace(',', '.')
    ...
    def sendVelLimitAction(self):
        ...
        trace('[UI] velocity limit editingFinished raw=%r', value)
        value = value.replace(',', '.')
    ...
    def sendVoltageLimitAction(self):
        ...
        trace('[UI] voltage limit editingFinished raw=%r', value)
        value = value.replace(',', '.')
